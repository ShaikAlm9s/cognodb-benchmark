...
class MemgraphAdapter(GraphDatabaseAdapter):
    ...
    def __init__(self):
        self.host = os.environ["MEMGRAPH_HOST"]
        self.port = os.environ["MEMGRAPH_PORT"]
        self.username = os.environ["MEMGRAPH_USERNAME"]
        self.password = os.environ["MEMGRAPH_PASSWORD"]
